...
#define ACT_BASE_PREP_SECS_PER_REF_VALUE (300.0f)
#define ACT_STR_S_L_REF_PROPORTION_OF_STR (1/ACT_INTENSITY_SCORE_1)
#define ACT_STR_S_L_REF_SMALL_STR (ACT_REF_STRENGHT/10)
#define ACT_STR_S_L_STR_TO_RESOURCES_REFERENCE_RATIO (5.0f)
#define ACT_STR_S_L_EFFECT_TIME_MULTIPLIER (5.0f)
...
#define ACT_STR_S_L_COST_PER_REF_STR ACT_REFERENCE_RESOURCES * ACT_STR_S_L_STR_TO_RESOURCES_REFERENCE_RATIO
