...
#define ACT_BASE_ATTACK_L_I_PREP_SECS_PER_REF_STR (10.0f)
#define ACT_ATTACK_G_S_SUGESTION_PREP_SECS_PER_INTENSITY (10.0f)

//Spefic Action details (calculated from the above):
#define ACT_BASE_ATTACK_L_I_PREP_TENTHS_OF_MS_PER_REF_STR (ACT_BASE_ATTACK_L_I_PREP_SECS_PER_REF_STR * TENTHS_OF_MS_IN_A_SECOND)
