...
#define ACT_WHY_BOTHER_THRESOLD (0.1f)
#define ACT_I_GUESS_THRESOLD (0.2f)
#define ACT_JUST_DO_IT_THRESOLD (0.75f)
...
#define ACT_RES_S_L_REF_PROPORTION_OF_INCOME (1.0f / ACT_INTENSITY_SCORE_1)
...
#define ACT_RES_S_L_COST_RELATIVE_WEIGHT_SQUARE_TERM (0.01f)
...
#define ACT_ATT_I_L_BATTLE_RED_PRN_STD_DEV_AT_REF_TIME (5.0f)
