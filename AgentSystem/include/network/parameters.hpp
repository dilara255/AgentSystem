...
#define NOTIONS_TO_KEEP_TRACK_EACH_DECISION_STAGE 5
#define SCORES_TO_KEEP_TRACK_EACH_DECISION_STAGE 3
...
#define TRADE_CAP_MULTIPLIER_FROM_INCOME (1.0f)
...
#define MAX_DEBT_TO_INCOME_RATIO (REF_TIME_TO_BANKRUPT)
#define STR_PROPORTION_DEFECTED_PER_SECOND (0.003f)
#define STR_DEFECTION_PROPORTION_TO_GO_TO_NEIGHBORS (0.6f)

//Diplomacy:
#define DIPLOMATIC_STANCES 5 //TODO: would this be better left to the enum class diploStances?
#define TOTAL_LA_INFO_RELATION_WEIGHT_FOR_GA_PER_SECOND (0.0003f)
#define MAX_DISPOSITION_RAISE_FROM_TRADE_PER_SECOND (0.0003f)
#define MAX_INFILTRATION_RAISE_FROM_TRADE_PER_SECOND (0.0002f)
//Note that while effects of trade suffer from saturation, alliance doesn't
#define REFERENCE_TRADE_SATURATION (4.0f)
#define PROPORTIONAL_WEIGHT_OF_ALLIANCE_COMPARED_TO_TRADE (2.0f)
#define PROPORTIONAL_WEIGHT_SAME_GA_COMPARED_TO_TRADE (0.5f)
...
#define PROPORTIONAL_WEIGHT_OF_WAR_COMPARED_TO_TRADE (2.0f)
...
#define INFILTRATION_CHANGE_FROM_NEIGHBOR_DISPOSITION_PER_SECOND (0.0004f)
#define MIN_DISPOSITION (-1.0f)
#define MAX_DISPOSITION (1.0f)
#define MIN_INFILTRATION (-1.0f)
#define MAX_INFILTRATION (1.0f)
#define MAX_DISPOSITION_FOR_INCREASE_FROM_TRADE (0.5f)
#define MAX_DISPOSITION_FOR_INCREASE_FROM_ALLIANCE (0.5f)
#define MAX_DISPOSITION_FOR_INCREASE_FROM_ALLIANCE_WITH_TRADE (0.75f)
#define MIN_DISPOSITION_FOR_DECREASE_FROM_WAR (-0.5f)
#define MAX_INFILTRATION_FOR_INCREASE_FROM_TRADE (0.5f)
#define MAX_INFILTRATION_FOR_INCREASE_FROM_ALLIANCE (0.5f)
#define MAX_INFILTRATION_FOR_INCREASE_FROM_ALLIANCE_WITH_TRADE (0.75f)
#define MIN_INFILTRATION_FOR_DECREASE_FROM_WAR (-0.5f)
#define MIN_INFILTRATION_FOR_DECREASE_FROM_DISPO (1.2f * MIN_DISPOSITION_FOR_DECREASE_FROM_WAR)
#define MAX_INFILTRATION_FOR_INCREASE_FROM_DISPO (MAX_INFILTRATION_FOR_INCREASE_FROM_ALLIANCE_WITH_TRADE)
...
#define EXPC_MINIMUM_CHANGE_TO_WORRY (2.0f * REF_RESOURCES)
...
#define MIN_ACT_WHY_BOTHER_THRESOLD (0.0f)
#define MIN_ACT_I_GUESS_THRESOLD (MIN_ACT_WHY_BOTHER_THRESOLD + MIN_DECISION_THRESHOLD_SEPARATIONS)
#define MIN_ACT_JUST_DO_IT_THRESOLD (MIN_ACT_I_GUESS_THRESOLD + MIN_DECISION_THRESHOLD_SEPARATIONS)
#define MAX_ACT_JUST_DO_IT_THRESOLD (1.0f - MIN_DECISION_THRESHOLD_SEPARATIONS)
#define MAX_ACT_I_GUESS_THRESOLD (MAX_ACT_JUST_DO_IT_THRESOLD - MIN_DECISION_THRESHOLD_SEPARATIONS)
#define MAX_ACT_WHY_BOTHER_THRESOLD (MAX_ACT_I_GUESS_THRESOLD - MIN_DECISION_THRESHOLD_SEPARATIONS)
#define ACT_MIN_INTENSITY (0.2f)
#define ACT_INTENSITY_I_GUESS (0.4f)
#define ACT_INTENSITY_JUST_DO_IT (1.5f)
#define ACT_INTENSITY_SCORE_1 (5.0f)
#define ACT_INTENSITY_DIFFERENCE_TO_I_GUESS (ACT_INTENSITY_I_GUESS - ACT_MIN_INTENSITY)
#define ACT_INTENSITY_DIFFERENCE_TO_JUST_DO_IT (ACT_INTENSITY_JUST_DO_IT - ACT_MIN_INTENSITY)
...
#define ACT_EXTRA_SCORE_MULTIPLIER (10.0f)
#define ACT_SUCESSIVE_MITIGATION_DAMPENNING_MULTIPLIER (0.8f) //will use this ^ rounds_done
#define ACT_MITIGATION_ROUNDS 2
#define ACT_GOAL_SHORTLIST_SIZE 2
#define ACT_CHOICE_SHORTLIST_SIZE 10
#define ACT_WHY_BOTHER_THRESOLD (0.2f)
#define ACT_I_GUESS_THRESOLD (0.5f)
#define ACT_JUST_DO_IT_THRESOLD (0.9f)
#define ACT_SCORE_PENALTY_HARD_REPEAT (0.9f)
#define ACT_SCORE_PENALTY_SOFT_REPEAT (0.25f)
#define ACT_SCORE_PENALTY_REPEAT_SELF (2.0f * ACT_SCORE_PENALTY_SOFT_REPEAT)
#define ACT_SCORE_PENALTY_EXACT_REPEAT_IMMEDIATE (ACT_SCORE_PENALTY_HARD_REPEAT)
#define ACT_SCORE_PENALTY_EXACT_REPEAT_REQUEST (2.0f * ACT_SCORE_PENALTY_HARD_REPEAT)
#define ACT_SCORE_PENALTY_DIFFERENT_TARGET_REPEAT_IMMEDIATE (ACT_SCORE_PENALTY_SOFT_REPEAT)
#define ACT_SCORE_PENALTY_DIFFERENT_TARGET_REPEAT_REQUEST (2.0f * ACT_SCORE_PENALTY_SOFT_REPEAT)

//Notion Calculation:
#define NTN_UPKEEP_TO_BASE_INCOME_RATIO_TO_WORRY (0.8f)
//TODO: rename parameters to better reflect wich notions are affected
...
#define NTN_DIPLO_STANCE_WEIGHT_PROPORTION_TO_REFS (2.5f)
#define NTN_GA_DIPLOMACY_WEIGHT_FOR_LAS (0.35f) //1 = only this will matter
#define NTN_MAX_ABSOLUTE_DISPOSITION_EXTRAPOLATION (MAX_DISPOSITION / 4.0f)
#define NTN_MULTIPLIER_OF_WAR_EFFECT_ON_DISTRUST (2.0f)
#define NTN_MISTRUST_THREATH_MULTIPLIER (5.0f)
#define NTN_MISTRUST_THREATH_OVERSHOOT_FACTOR (3.0f)
#define NTN_MIN_MISTRUST_THREATH_MULTIPLIER (1.0f)
#define NTN_TRADE_IMPACT_MULTIPLIER_FOR_TRUST (5.0f)
#define NTN_UNCERTAINTY_WEIGHT (0.5f)
#define NTN_DISPOSITION_CHANGE_MULTIPLIER (5.0f)
#define NTN_N4_TRUST_MAX_ABSOLUTE_CHANGE_FROM_STANCE (MAX_DISPOSITION)
#define NTN_N4_TRUST_MAX_EFFECTIVE_NOTION_BASE (MAX_DISPOSITION + NTN_N4_TRUST_MAX_ABSOLUTE_CHANGE_FROM_STANCE)
#define NTN_N4_TRUST_DELINEARIZATION_EXPONENT (1.0f)
#define NTN_N1_STRONG_PROPORTION_FOR_MAX_SCORE (5.0f)
#define NTN_N0_LOW_DEF_TO_RES_PROPORTION_FOR_MAX_SCORE (10.0f)
#define NTN_N0_LOW_DEF_TO_RES_MIN_PROPORTION_OF_REF_READS_TO_FIXED_REFERENCES (0.1f)
#define NTN_S1_LOW_DEF_TO_RES_MAX_EFFECTIVE_NOTION_BASE (NTN_N0_LOW_DEF_TO_RES_PROPORTION_FOR_MAX_SCORE / 2)
#define NTN_S1_LOW_DEF_TO_RES_DELINEARIZATION_EXPONENT (1.0f)
#define NTN_S1_LOW_DEF_TO_RES_PROPORTION_OF_ON_ATTACK_AS_DEFENSE (0.5f)

//Actions (general):
#define PRNS_PER_ACT 5
#define MAX_ACT_PRNS_PER_AGENT (PRNS_PER_ACT * MAX_ACTIONS_PER_AGENT)
#define ACT_REFERENCE_RESOURCES REF_RESOURCES
...
#define ACT_FREE_ACTIONS (1)
#define ACT_SUPERLINEAR_WEIGHT (1.0f)
#define ACT_SUPERLINEAR_EXPO (3)
#define ACT_REFERENCE_UNITS_OF_DISTANCE_BETWEEN_NEIGHBORS (250.0f)
#define ACT_BASE_PREP_SECS_PER_REF_VALUE (80.0f)
#define ACT_BASE_TRAVEL_SECS_PER_REFERENCE_DISTANCE (ACT_BASE_PREP_SECS_PER_REF_VALUE)
#define ACT_REF_STRENGHT (REF_RESOURCES / 2)
#define ACT_REF_INCOME_TO_REF_RESOURCES_RATIO (0.01f)
#define MINIMUM_REF_INCOME (ACT_REF_INCOME_TO_REF_RESOURCES_RATIO / 6.0f)
#define ACT_REF_DEFENSE (1.15f * ACT_REF_STRENGHT)

//Spefic Action details:

#define ACT_INTENS_ATTACK_MARGIN_AT_JUST_DO_IT (1.0f) //extra troops to read on enemies defenses
#define ACT_INTENS_ATTACK_MARGIN_INTENSITY_MULTIPLIER (ACT_INTENS_ATTACK_MARGIN_AT_JUST_DO_IT / ACT_INTENSITY_JUST_DO_IT)
#define ACT_MAX_SUGESTION_INTENSITY (3.0f)

#define ACT_STR_S_L_REF_PROPORTION_OF_STR (0.8f / ACT_INTENSITY_SCORE_1)
#define ACT_STR_S_L_REF_SMALL_STR (ACT_REF_STRENGHT /10.0f)
#define ACT_STR_S_L_REF_STR_TO_REF_RESOURCES_REFERENCE_RATIO (2.0f)
#define ACT_STR_S_L_EFFECT_TIME_MULTIPLIER (3.0f)
#define ACT_STR_S_L_OVERDRAFT_FUNDS_PROPORTION (0.2f)
#define ACT_STR_S_L_MINIMUM_SECONDS_TO_BANKRUPCY_WITH_NEW_TROOPS (NOTIONS_AND_ACTIONS_REF_PERIOD_SECS)
#define ACT_STR_S_L_PITTY_INTENSITY_PROPORTION (0.1f)
#define ACT_RES_S_L_REF_SMALL_INCOME_QUOTIENT (6.0f)
#define ACT_RES_S_L_REF_PROPORTION_OF_INCOME_TO_RAISE (0.8f / ACT_INTENSITY_SCORE_1)
#define ACT_RES_S_L_COST_PER_REF_INCOME (0.35f * ACT_REFERENCE_RESOURCES)
#define ACT_RES_S_L_EFFECT_TIME_MULTIPLIER (3.0f)
#define ACT_RES_S_L_OVERDRAFT_FUNDS_PROPORTION (0.4f)
#define ACT_RES_S_L_PITTY_FUNDS_PROPORTION (0.2f)
#define ACT_RES_S_L_COST_RELATIVE_WEIGHT_SQUARE_TERM (0.1f)
#define ACT_ATT_I_L_DISPO_LOSS_FROM_ATTACK (0.1f)
#define ACT_ATT_I_L_DEFENDER_STR_READ_BASE (1.0f)
#define ACT_ATT_I_L_MAX_DEFENDER_STR_READ_MULT (5.0f)
...
#define ACT_ATT_I_L_MAX_LOOT_PER_HAND (8.0f * ACT_REFERENCE_RESOURCES / ACT_REF_STRENGHT)
#define ACT_ATT_I_L_MIN_PROPORTIONAL_RESOURCE_RESERVE_FROM_LOOT (0.1f)
#define ACT_ATT_I_L_MAX_LOOT_EFFECTIVENESS (2.0f)
#define ACT_ATT_I_L_INCOME_PROPORTION_NOT_PROTECTED_FROM_LOOT (0.35f)
//Proportion of loot can create a network-wide pressure if < 1
//or make attacks actually pay off if >> 1
#define ACT_ATT_I_L_PROPORTION_OF_LOOT_ACTUALLY_PROFITED (5.0f) 
#define ACT_ATT_I_L_MINIMUM_ATTACK_INTENSITY (1.0f)
#define ACT_ATT_I_L_ATTACKER_SCORE_BONUS_IF_NO_DEFENDERS (0.15f)
#define ACT_ATT_I_L_MORALE_IMPACT_FACTOR (1.0f)
#define ACT_ATT_S_G_SUGESTION_PREP_SECS_PER_INTENSITY (10.0f)
#define ACT_ATT_I_L_MINIMUM_SIZE_FOR_REDUCED_ATTACK (7.5f)
#define ACT_ATT_I_L_BATTLE_RED_PRN_STD_DEV_AT_REF_TIME (2.0f)
#define ACT_ATT_I_L_ABS_SCORE_TO_END_FIGHT (1.0f)
#define ACT_ATT_I_L_THRESHOLD_FOR_SCOUTING (0.125f)
#define ACT_ATT_I_L_LONG_TERM_AUX_ON_SCOUTING_RUN (-1.0f)

//Action definitions (calculated from above):
#define ACT_REF_INCOME (ACT_REFERENCE_RESOURCES * ACT_REF_INCOME_TO_REF_RESOURCES_RATIO)
#define ACT_ATT_I_L_BASE_INCOME_LOSS_PER_LOOT ( ACT_REF_INCOME / ACT_REFERENCE_RESOURCES )
#define ACT_RES_S_L_REF_SMALL_INCOME (ACT_REF_INCOME / ACT_RES_S_L_REF_SMALL_INCOME_QUOTIENT)
...
#define DEFAULT_SMALL_FLOAT_FOR_QUOTIENTS (0.1f)
...
#define DEFAULT_LA_STR_THRESHOLD_FOR_UPKEEP (ACT_REF_STRENGHT * LA_REF_STR_PROPORTION_THRESHOLD_FOR_UPKEEP)
#define DEFAULT_LA_ATTRITION_LOSS_RATE 0
#define DEFAULT_LA_TROOPS_ON_ATTACKS 0

#define DEFAULT_LA_RESOURCES ACT_REFERENCE_RESOURCES
#define DEFAULT_LA_INCOME ACT_REF_INCOME
#define DEFAULT_LA_TRADE_RATE 0
#define DEFAULT_LA_TAX_RATE 0
