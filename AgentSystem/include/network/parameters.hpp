...
#define EXPC_MINIMUM_CHANGE_TO_WORRY (2.0f * ACT_REFERENCE_RESOURCES)
...
#define ACT_INTENSITY_WHY_BOTHER (0.4f)
#define ACT_INTENSITY_JUST_DO_IT (2.0f)
...
#define ACT_SCORE_PENALTY_SOFT_REPEAT (0.1f)
#define ACT_SCORE_PENALTY_REPEAT_SELF (0.75f * ACT_SCORE_PENALTY_SOFT_REPEAT)
...
#define ACT_REF_INCOME_TO_REF_RESOURCES_RATIO (0.00667f)
...
#define ACT_STR_S_L_REF_PROPORTION_OF_STR (2.5f / ACT_INTENSITY_SCORE_1)
#define ACT_STR_S_L_REF_SMALL_STR (ACT_REF_STRENGHT / 5)
#define ACT_STR_S_L_REF_STR_TO_REF_RESOURCES_REFERENCE_RATIO (4.0f)
...
#define ACT_RES_S_L_COST_PER_REF_INCOME (1.0f * ACT_REFERENCE_RESOURCES)
#define ACT_RES_S_L_EFFECT_TIME_MULTIPLIER (3.0f)
#define ACT_RES_S_L_OVERDRAFT_FUNDS_PROPORTION (0.4f)
#define ACT_RES_S_L_COST_RELATIVE_WEIGHT_SQUARE_TERM (0.02f)
...
#define ACT_ATT_I_L_MAX_LOOT_PER_HAND (2.0f * ACT_REFERENCE_RESOURCES / ACT_REF_STRENGHT)
...
#define ATT_I_L_MORALE_IMPACT_FACTOR (1.0f)
