...
#define ACT_SCORE_PENALTY_REPEAT_SELF (ACT_SCORE_PENALTY_SOFT_REPEAT)
...
#define NTN_DIPLO_STANCE_WEIGHT_PROPORTION_TO_REFS (1.5f)
...
#define NTN_TRADE_IMPACT_MULTIPLIER_FOR_TRUST (4.0f)
#define NTN_UNCERTAINTY_WEIGHT (0.75f)
#define NTN_N4_TRUST_MAX_ABSOLUT_CHANGE_FROM_STANCE (MAX_DISPOSITION)
#define NTN_N4_TRUST_MAX_EFFECTIVE_NOTION_BASE (MAX_DISPOSITION + NTN_N4_TRUST_MAX_ABSOLUT_CHANGE_FROM_STANCE)
...
#define ACT_ATT_I_L_PROPORTION_OF_LOOT_ACTUALLY_PROFITED (0.75f) //creates a network-wide pressure
